...
@NamedQueries({
    ...
    @NamedQuery(name = "Propertytypes.findPropertyTypeByTypeId", query = "SELECT p.propType FROM Propertytypes p WHERE p.typeId = :typeId"),
    @NamedQuery(name = "Propertytypes.findByPropType", query = "SELECT p FROM Propertytypes p WHERE p.propType = :propType")})
