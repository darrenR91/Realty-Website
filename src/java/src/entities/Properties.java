...
@NamedQueries({
    ...
    // SELECT e FROM Properties e WHERE e.id in :ids
    
    @NamedQuery(name = "Properties.getAllFavourites", query = "SELECT e FROM Properties e WHERE e.id in :ids"),
    @NamedQuery(name = "Properties.getAllLocations", query = "SELECT p.city FROM Properties p order by p.city"),
    @NamedQuery(name = "Properties.getRoomCount", query = "SELECT p.bedrooms FROM Properties p order by p.bedrooms"),
    @NamedQuery(name = "Properties.getRecentPropertys", query = "SELECT p FROM Properties p WHERE p.dateAdded BETWEEN :startDate AND :todaysDate"),
    @NamedQuery(name = "Properties.getOldest", query = "SELECT p FROM Properties p order by p.dateAdded ASC"),
...
public class Properties implements Serializable {
    ...
    public Properties(Integer id, Date dateAdded) {
        this.id = id;
