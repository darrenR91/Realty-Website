...
@NamedQueries({
    ...
    @NamedQuery(name = "Agents.updateProfile", query = "UPDATE Agents a SET a.name=:name, a.phone=:phone, a.fax=:fax, a.email=:email WHERE a.agentId = :agentId"),
...
public class Agents implements Serializable {
    ...
    public Agents(Integer agentId, String username, String password, String agentImage) {
        this.agentId = agentId;
    ...
    public String toString() {
        return "src.entities.Agents[ agentId=" + agentId + " ]";
    }
