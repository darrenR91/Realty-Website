        ...
        <article class="col1">
            ...
            <div id="demo_jui">
                ...
                <tr>
                    ...
                    <td><button class="button" onclick="location.href='ManagePropertys?propID=${aProperty.id}'">Update</button>
            ...
            <form id="ContactForm" method="POST" name="setAgentsProfile" action="ManageAgents">
              <div>
                <div  class="wrapper"> <span>Name:</span>
                  <input type="text" class="input" value="${agent.name}" id="name">
                </div>
                <div  class="wrapper"> <span>Phone Number:</span>
                  <input type="text" class="input" value="${agent.phone}"  id="phoneNumber" >
                </div>
                  <div  class="wrapper"> <span>Fax Number:</span>
                  <input type="text" class="input" value="${agent.fax}"  id="faxNumber">
                </div>
                  <div  class="wrapper"> <span>Email Address:</span>
                  <input type="text" class="input" value="${agent.email}"  id="emailAddress">
                </div>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="button" value="Save" name="setAgentsProfile" /></div>
            </form>
          </div>       -->
        </article>
        <article class="col2">
